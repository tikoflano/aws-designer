...
} from "./eventbridgeSchedulerPublishesSnsStandard.definition.ts";

export class EventbridgeSchedulerPublishesSnsStandardHandlerV1
  implements EdgeRelationshipHandler
{
  public readonly definition = eventbridgeSchedulerPublishesSnsStandardDefinition;
  ...
  public apply(ctx: GraphCompileContext, args: EdgeHandlerArgs): void {
    ...
    const edgeCfg = eventbridgeSchedulerPublishesSnsStandardConfigSchema.parse(
      edge.config,
    );
